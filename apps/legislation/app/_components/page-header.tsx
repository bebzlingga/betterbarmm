...
export function PageHeader({
	...
	if (isBrand) {
		...
		const titleSize = compact
			...
			: size === 'hero'
				? 'text-[3.5rem] sm:text-[5.25rem] lg:text-[6.5rem]'
				: 'text-[3.25rem] sm:text-[4.75rem] lg:text-[5.5rem]'
	...
	return (
		<section className='mx-auto max-w-[88rem] px-6 pb-12 pt-16 lg:px-8 lg:pb-16 lg:pt-24'>
			<p className='eyebrow'>{eyebrow}</p>

			<h1 className='mt-4 max-w-3xl text-[2rem] font-semibold leading-[1.1] text-[var(--ink)] sm:text-[2.75rem]'>
				{title}
			</h1>
