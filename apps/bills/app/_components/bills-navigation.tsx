...
export type BillsNavItem = "overview" | "about" | "data" | "methodology";

type BillsNavigationProps = {
  activeItem?: BillsNavItem;
};

const navItems = [
  { key: "overview", label: "Bills", href: "/" },
  { key: "about", label: "About", href: "/about" },
  { key: "data", label: "Data", href: "/data" },
  { key: "methodology", label: "Methodology", href: "/methodology" },
] as const;

export function BillsNavigation({ activeItem = "overview" }: BillsNavigationProps) {
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const navLinkClass = (item: BillsNavItem) =>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-3 pt-2 sm:px-8">
        ...
        <div className="flex items-center justify-between gap-4 py-2">
          ...
          <button
            ...
            aria-controls="bills-mobile-menu"
