...
export const alt = 'BetterBARMM — public records for the Bangsamoro'
				...
				<div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
					...
					<div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 24 }}>
						<div style={{ color: '#cfc9bb' }}>
							Elections, laws, budgets and local government — traced to the source.
						</div>
						<div style={{ color: '#d3a95f', letterSpacing: 2 }}>betterbarmm.com</div>
					</div>
				</div>
			</div>
		),
