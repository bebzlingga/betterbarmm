	...
	return (
		<footer className='border-t border-[var(--ink)] bg-[var(--paper)] py-10 pb-5 text-[var(--ink)]'>
			<div className='mx-auto max-w-7xl px-5 sm:px-8'>
				<div className='grid border-b border-[var(--rule)] pb-16 pt-8 lg:grid-cols-[0.72fr_1.28fr] lg:gap-12'>
					<div>
						{/* <p className='eyebrow'>Transparency engine</p> */}
						<h2 className='mt-3 text-3xl font-extrabold leading-none tracking-[-0.03em] sm:text-4xl pr-24'>Public information should be usable by the public.</h2>
					</div>
					<p className='mt-3! max-w-3xl text-base leading-7 text-[var(--ink-2)] lg:mt-0 pl-16'>
				...
				<p className='mt-10 font-mono text-[10px] uppercase leading-4 tracking-[0.14em] text-[var(--ink-3)] sm:tracking-[0.2em]'>
				...
				<div className='mt-9 flex flex-col justify-between gap-4 border-t border-[var(--rule)] pt-5 font-mono text-[10px] uppercase leading-6 tracking-[0.16em] text-[var(--ink-3)] sm:flex-row sm:items-center sm:tracking-[0.22em]'>
					<p>
						Site by{' '}
						<a
							href='https://bebz.dev'
