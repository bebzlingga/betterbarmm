 ...
 *
 * The key is shared with the other BetterBARMM apps on purpose: they sit on
 * subdomains of one site, and a reader who picked dark on the registry should
 * not be flashed white on the way back here.
 */
