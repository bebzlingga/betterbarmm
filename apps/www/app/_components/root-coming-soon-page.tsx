			...
			<section className='mx-auto max-w-7xl px-8 py-20 sm:py-24 lg:py-32'>
				<div className='grid border-y border-[var(--ink)] sm:grid-cols-2 lg:grid-cols-3'>
					{notes.map((note, index) => (
						<div
							key={note}
							className='border-b border-[var(--rule)] py-5 sm:border-r sm:p-6 sm:last:col-span-2 sm:last:border-r-0 sm:[&:nth-child(2n)]:border-r-0 lg:last:col-span-1 lg:border-b-0 lg:[&:nth-child(2n)]:border-r lg:[&:nth-child(3n)]:border-r-0'
						>
